...
class BannerGeneratorService {
  ...
  _generateBaseStyles(theme) {
    ...
    return `
      ...
      .cmp-button[data-cmp-action="reject_all"] {
        background-color: ${theme.secondaryColor || '#f1f1f1'};
        color: ${theme.secondaryButtonTextColor || '#333333'};
      }
      
      .cmp-button[data-cmp-action="reject_all"]:hover {
        background-color: ${this._adjustColor(theme.secondaryColor || '#f1f1f1', -10)};
      }

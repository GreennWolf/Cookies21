...
const validateContainerNesting = (parentContainer, childComponent, allComponents = []) => {
  // Básica validación de profundidad
  const depth = calculateNestingDepth(childComponent, allComponents);
  if (depth >= MAX_NESTING_DEPTH) {
    return { isValid: false, reason: 'Máxima profundidad alcanzada' };
  }

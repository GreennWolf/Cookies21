    ...
    <div className="space-y-4 border-t pt-4">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          {/* Modo Libre */}
          <button
            onClick={() => onContainerConfigChange('displayMode', 'libre')}
          ...
          {/* Modo Flex */}
          <button
            onClick={() => onContainerConfigChange('displayMode', 'flex')}
            className={`group relative p-3 text-xs border-2 rounded-lg flex flex-col items-center gap-2 transition-all duration-200 ${
              displayMode === 'flex'
          ...
          {/* Modo Grid */}
          <button
            onClick={() => onContainerConfigChange('displayMode', 'grid')}
            className={`group relative p-3 text-xs border-2 rounded-lg flex flex-col items-center gap-2 transition-all duration-200 ${
              displayMode === 'grid'
        ...
        <div className="space-y-4 p-4 bg-purple-50 border border-purple-200 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              ...
              <select
                value={containerConfig.justifyItems || 'start'}
            ...
            <div className="space-y-2">
              ...
              <select
                value={containerConfig.alignItems || 'start'}
                onChange={(e) => onContainerConfigChange('alignItems', e.target.value)}
                className="w-full p-2 text-sm border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
              >
                <option value="start">Inicio</option>

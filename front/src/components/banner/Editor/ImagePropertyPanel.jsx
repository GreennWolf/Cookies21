...
import { Upload, RotateCcw, Maximize2, AlignCenter, AlignLeft, AlignRight, Lock, Unlock, RotateCw } from 'lucide-react';
...
const ImagePropertyPanel = ({
  ...
  // Cargar información de la imagen y rotación actual
  useEffect(() => {
  ...
  const handleImageUpload = useCallback((imageUrl) => {
    // Actualizar contenido con nueva URL
    onUpdateContent(component.id, imageUrl);
  }, [component.id, onUpdateContent]);

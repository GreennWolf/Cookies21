...
const handleAutocompleteSize = (
  ...
  if (compRect) {
    ...
    console.log(`Usando dimensiones del compRect: ${componentWidth}×${componentHeight}px`);
  } 
  // 2. Intentar obtener del elemento DOM directamente
    ...
    console.log(`Usando dimensiones del DOM: ${componentWidth}×${componentHeight}px`);
  }
  // 3. Usar width/height que nos pasaron (menos preciso)
  else if (dimensions.width && dimensions.height) {
    componentWidth = dimensions.width;
    componentHeight = dimensions.height;
    console.log(`Usando dimensiones proporcionadas: ${componentWidth}×${componentHeight}px`);
  }
  ...
  if (unit === '%') {
    ...
    if (propertyName === 'width' || propertyName === 'maxWidth') {
      ...
      if (componentWidth > 0) {
        ...
        console.log(`Usando ancho actual del componente: ${idealValue.toFixed(2)}% (${componentWidth}px de ${canvasWidth}px)`);
      } 
      // 2. Si no hay ancho actual, usar valores predeterminados según tipo
        ...
        console.log(`Usando ancho predeterminado: ${idealValue}% para ${componentType}`);
      }
    ...
    // Si es height o maxHeight
      ...
      if (componentHeight > 0) {
        ...
        console.log(`Usando altura actual del componente: ${idealValue.toFixed(2)}% (${componentHeight}px de ${canvasHeight}px)`);
      } 
      // 2. Si no hay altura actual, usar valores predeterminados según tipo
        ...
        switch (componentType) {
          ...
          case 'image':
            ...
            if (componentWidth > 0 && compRect) {
              ...
              console.log(`Manteniendo proporción (${ratio.toFixed(2)}) de imagen: ${idealValue.toFixed(2)}%`);
            } else {
              idealValue = 40;
            }
            break;
        ...
        console.log(`Usando altura predeterminada: ${idealValue}% para ${componentType}`);
      }
  ...
  // PÍXELES
    ...
    if (propertyName === 'width' || propertyName === 'maxWidth') {
      ...
      if (componentWidth > 0) {
        ...
        console.log(`Usando ancho actual del componente: ${idealValue}px`);
      } 
      // 2. Si no hay ancho actual, calcular según tipo y canvas
        ...
        console.log(`Calculando ancho automático: ${idealValue.toFixed(0)}px para ${componentType}`);
      }
    ...
    // Si es height o maxHeight
      ...
      if (componentHeight > 0) {
        ...
        console.log(`Usando altura actual del componente: ${idealValue}px`);
      } 
      // 2. Si no hay altura actual, calcular según tipo y canvas
        ...
        switch (componentType) {
          ...
          case 'image':
            ...
            if (componentWidth > 0 && compRect) {
              ...
              console.log(`Manteniendo proporción (${ratio.toFixed(2)}) de imagen: ${idealValue.toFixed(0)}px`);
            } else {
        ...
        console.log(`Calculando altura automática: ${idealValue.toFixed(0)}px para ${componentType}`);
      }

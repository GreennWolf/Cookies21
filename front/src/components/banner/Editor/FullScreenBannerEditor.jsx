...
function FullScreenBannerEditor({ initialConfig, onSave, onBack }) {
  ...
  const handleUpdatePosition = (componentId, position) => {
    console.log(`🎯 handleUpdatePosition: Actualizando posición de ${componentId}`, position);
    ...
    if (component) {
      ...
      console.log(`💾 Posición segura creada para ${componentId}:`, safePosition);
  ...
  // Función para reordenar hijos de un contenedor - Versión mejorada
  const reorderContainerChildren = (containerId, newChildrenOrder) => {
    console.log(`🔄 FullScreenBannerEditor: reordenando hijos para ${containerId}`, newChildrenOrder);
    ...
    const updateComponents = (components) => {
      return components.map(comp => {
        ...
        if (comp.id === containerId && comp.type === 'container') {
          console.log(`✓ Contenedor ${containerId} encontrado. Actualizando hijos.`);
    ...
    console.log(`✅ Hijos reordenados exitosamente para contenedor ${containerId}`);
  ...
  const ensureComponentWithinBounds = (componentId, position, componentWidth, componentHeight) => {
    console.log(`🔍 Validando posición para ${componentId}:`, position);
    ...
    console.log(`✅ Posición ajustada para ${componentId}:`, adjustedPosition);

...
function BannerEditor({ initialConfig, onSave, isFullscreen = false }) {
  ...
  const handleDeleteComponent = (componentId) => {
    console.log('🎯 handleDeleteComponent llamado con:', componentId);
    
    if (isChildComponent(componentId)) {
      console.log('📦 Es un componente hijo');
      // Verificar si es un componente obligatorio antes de eliminar
      ...
      if (isEssential) {
        console.log('🔗 Componente obligatorio detectado, usando unattachFromContainer:', componentId);
        unattachFromContainer(componentId);
      } else {
        console.log('🗑️ Componente no obligatorio, usando deleteChildComponent:', componentId);
        deleteChildComponent(componentId);
      }
    } else {
      console.log('📄 Es un componente principal, usando deleteComponent:', componentId);

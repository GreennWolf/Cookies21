    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-6 rounded shadow transition-shadow hover:shadow-md">
          ...
          <p className="text-3xl font-bold" style={{ color: 'rgba(75, 192, 192, 1)' }}>{formatPercentage(rates.acceptanceRate)}</p>
        ...
        <div className="bg-white p-6 rounded shadow transition-shadow hover:shadow-md">
          ...
          <p className="text-3xl font-bold" style={{ color: 'rgba(255, 99, 132, 1)' }}>{formatPercentage(rates.rejectionRate)}</p>
        ...
        <div className="bg-white p-6 rounded shadow transition-shadow hover:shadow-md">
          ...
          <p className="text-3xl font-bold" style={{ color: 'rgba(54, 162, 235, 1)' }}>{formatPercentage(rates.customizationRate)}</p>

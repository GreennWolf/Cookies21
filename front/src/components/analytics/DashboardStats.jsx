    ...
    datasets: [
      {
        ...
        data: [
          safeStats.avgAcceptanceRate * 100, 
          safeStats.avgRejectionRate * 100, 
          safeStats.avgCustomizationRate * 100,
          safeStats.avgCloseRate * 100,
          safeStats.avgNoInteractionRate * 100
        ],
        backgroundColor: [
          'rgba(75, 192, 192, 0.8)',
          'rgba(255, 99, 132, 0.8)',
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-6 rounded shadow hover:shadow-md transition-shadow">
          ...
          <p className="text-3xl font-bold text-[#235C88]">{formatPercentage(safeStats.avgAcceptanceRate)}</p>
        </div>
        
        <div className="bg-white p-6 rounded shadow hover:shadow-md transition-shadow">
          <h3 className="text-lg font-medium text-gray-600 mb-2">Tasa de Personalización</h3>
          <p className="text-3xl font-bold text-[#235C88]">{formatPercentage(safeStats.avgCustomizationRate)}</p>
        </div>
      </div>

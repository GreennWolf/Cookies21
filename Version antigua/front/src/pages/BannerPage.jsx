...
import { AlertCircle, Search, Edit, Archive, Clock, Monitor, Tablet, Smartphone ,Code} from 'lucide-react';
...
function BannerPage() {
  ...
  const handleArchive = async (templateId) => {
    try {
      ...
      fetchTemplates({ search: searchTerm.trim(), status: statusFilter });
    } catch (err) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Mis Plantillas de Banner</h1>
        <Link 
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {/* Nuevo botón para generar script */}
                  <Link 
